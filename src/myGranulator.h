#ifndef STK_MYGRANULATOR_H
#define STK_MYGRANULATOR_H
...
namespace stk {
    ...
    class myGranulator: public Generator
    {
    public:
        //! Default constructor.
        myGranulator( void );
        ...
        myGranulator( unsigned int nVoices, std::string fileName, bool typeRaw = false );
        ...
        void setGrainParameters( unsigned int duration = 30, unsigned int rampPercent = 50,
                                int offset = 0, unsigned int delay = 0, unsigned int start = 0);
        ...
        /*!
         Returns the length of the loaded file
         */
        StkFloat fileSize() { return data_.frames(); };
    ...
    protected:
        ...
        void calculateGrain( myGranulator::Grain& grain );
    ...
    inline StkFloat myGranulator :: lastOut( unsigned int channel )
    {
    ...
    inline StkFrames& myGranulator :: tick( StkFrames& frames, unsigned int channel )
    {
